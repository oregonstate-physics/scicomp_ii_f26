...
# ROOT is the repository being checked; EXPECTED always sits beside this file.
#
...
# Part 35): a fresh copy of this file and its rules is run from the grading
...
# can be corrected mid-term. Unset, nothing below behaves any differently.
